...
void StylePhantomLight(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_TitleBg] = ImVec4(0.92f, 0.92f, 0.92f, 0.90f);
    ...
    colors[ImGuiCol_MenuBarBg] = ImVec4(0.94f, 0.94f, 0.94f, 0.85f);
    ...
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.60f, 0.60f, 0.60f, 0.80f);
    ...
    colors[ImGuiCol_DockingPreview] = colors[ImGuiCol_HeaderActive] * ImVec4(0.0f, 0.0f, 0.0f, 0.7f);
