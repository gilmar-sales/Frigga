...
![Frigga Editor — Gameplay workflow](docs/editor-gameplay.jpg)
...
Pinned FetchContent tags (see root `CMakeLists.txt`): Freyr `v0.40.0-hierarchy`, Freya `v0.55.0`, Jolt `v5.5.0`, ImGui `docking` fork.
