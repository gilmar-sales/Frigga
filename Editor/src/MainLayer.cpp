...
#include <Gui/Extensions/Extensions.hpp>
...
MainLayer::MainLayer(shared<fg::Scene> scene): fg::Layer("Dock Layer"), m_scene(scene)
{
    m_tabIds = {
        {"Layout",    new GamePlayLayer(m_scene)},
        {"Animation", new ECSLayer()            },
        {"Audio",     new ECSLayer()            },
        {"Shading",   new ECSLayer()            },
        {"Scripting", new ECSLayer()            },
        {"ECS",       new ECSLayer()            }
    };
